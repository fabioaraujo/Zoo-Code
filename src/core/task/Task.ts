...
export class Task extends EventEmitter<TaskEvents> implements TaskLike {
	...
	/**
	 * Request-scoped resolved command environment. Resolved once per API
	 * request and shared by system prompt, tool descriptions, and runtime
	 * execution. See ARCH-TERMINAL-001.
	 */
